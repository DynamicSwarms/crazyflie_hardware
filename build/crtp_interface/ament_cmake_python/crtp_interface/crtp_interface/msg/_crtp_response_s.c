...
bool crtp_interface__msg__crtp_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crtp_interface.msg._crtp_response.CrtpResponse", full_classname_dest, 46) == 0);
  }
  crtp_interface__msg__CrtpResponse * ros_message = _ros_message;
  {  // channel
  ...
  {  // address
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->address.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'address'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of CrtpResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crtp_interface.msg._crtp_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CrtpResponse");
  ...
  {  // address
    ...
    if (ros_message->address.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->address.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->address.size * sizeof(uint8_t));
      assert(data != NULL);

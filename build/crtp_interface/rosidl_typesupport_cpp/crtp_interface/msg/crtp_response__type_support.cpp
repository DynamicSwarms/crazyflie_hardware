...
static const _CrtpResponse_type_support_symbol_names_t _CrtpResponse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crtp_interface, msg, CrtpResponse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crtp_interface, msg, CrtpResponse)),
  }
};
...
{
  return &::crtp_interface::msg::rosidl_typesupport_cpp::CrtpResponse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crtp_interface, msg, CrtpResponse)() {
  return get_message_type_support_handle<crtp_interface::msg::CrtpResponse>();
}

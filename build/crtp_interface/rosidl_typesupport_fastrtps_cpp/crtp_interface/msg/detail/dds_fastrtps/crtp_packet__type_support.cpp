...
#include "crtp_interface/msg/detail/crtp_packet__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crtp_interface::msg::CrtpPacket;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crtp_interface::msg::CrtpPacket *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crtp_interface::msg::CrtpPacket *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CrtpPacket__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const crtp_interface::msg::CrtpPacket *>(
...
static size_t _CrtpPacket__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CrtpPacket(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CrtpPacket__callbacks = {
  "crtp_interface::msg",
  "CrtpPacket",
...
static rosidl_message_type_support_t _CrtpPacket__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CrtpPacket__callbacks,
...
{
  return &crtp_interface::msg::typesupport_fastrtps_cpp::_CrtpPacket__handle;
}

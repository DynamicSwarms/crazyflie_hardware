...
bool crtp_interface__msg__crtp_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crtp_interface.msg._crtp_packet.CrtpPacket", full_classname_dest, 42) == 0);
  }
  crtp_interface__msg__CrtpPacket * ros_message = _ros_message;
  {  // port
...
{
  /* NOTE(esteve): Call constructor of CrtpPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crtp_interface.msg._crtp_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CrtpPacket");
  ...
  {  // data
    ...
    memcpy(dst, src, 31 * sizeof(uint8_t));
    Py_DECREF(field);
  }
  {  // data_length
    PyObject * field = NULL;
